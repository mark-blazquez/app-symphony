...
class Controlador2Controller extends AbstractController
{
    #[Route('/controlador2', name: 'app_controlador2')]
    public function index(Request $request): Response
    {
		$cookies = $request->cookies;

		if ($cookies->has('usuario')){
			$process = new Process(['/usr/bin/kubectl', 'get', 'service']);
		...
		return $this->render('controlador2/index.html.twig', [

...
class Controlador3Controller extends AbstractController
{
    #[Route('/controlador3', name: 'app_controlador3')]
    public function index(Request $request): Response
    {		
		$cookies = $request->cookies;

		if ($cookies->has('usuario')){
			$process = new Process(['/usr/bin/kubectl', 'get', 'deployment']);
		...
		return $this->render('controlador3/index.html.twig', [
